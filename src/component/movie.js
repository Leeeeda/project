...
function Movie (){
    ...
    let [kMovie2] = useState([9,16,4,5,41,42,45,47,15,8]);
    let [kMovie3] = useState([4,15,16,47,2]);
    
    let [fMovie1] = useState([10,14,24,34,26,35,29,17,18,13]);
    let [fMovie2] = useState([6,7,10,20,21,27,32,35,37,46]);
    let [fMovie3] = useState([18,28,23,21,37]);

    let [comedi1] = useState([0,1,3,4,11,17,24,30,31,47]);
    let [comedi2] = useState([6,7,12,32,20]);
    let [comedi3] = useState([24,26,27,18,19]);

    let [horror1] = useState([36,37,38,46,35,34,39,43,44,40]);
    let [horror2] = useState([43,44,47,39,36]);
    let [horror3] = useState([41,42,43,44,45]);

    let [romance1] =useState([20,23,19,29,22,17,18,21,6,48]);
    let [romance2] =useState([23,21,19,18,17]);
    let [romance3] =useState([17,19,6,20,22]);
    
    let [action1] =useState([16,14,8,10,47,13,12,9,41,11]);
    let [action2] =useState([14,9,13,11,12]);
    let [action3] =useState([11,12,13,16,15]); 
